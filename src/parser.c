...
enum ts_symbol_identifiers {
  anon_sym_STAR = 1,
  aux_sym_multiplication_token1 = 2,
  anon_sym_GT = 3,
  anon_sym_PLUS = 4,
  anon_sym_LPAREN = 5,
  anon_sym_RPAREN = 6,
  ...
  sym_id = 24,
  sym_text = 25,
  aux_sym_tag_repeat1 = 26,
};

static const char * const ts_symbol_names[] = {
  [ts_builtin_sym_end] = "end",
  [anon_sym_STAR] = "*",
  [aux_sym_multiplication_token1] = "multiplication_token1",
  [anon_sym_GT] = ">",
  [anon_sym_PLUS] = "+",
  [anon_sym_LPAREN] = "(",
  [anon_sym_RPAREN] = ")",
...
static const TSSymbol ts_symbol_map[] = {
  ...
  [aux_sym_multiplication_token1] = aux_sym_multiplication_token1,
...
static bool ts_lex(TSLexer *lexer, TSStateId state) {
  ...
  switch (state) {
    case 0:
      ...
      if (set_contains(sym__identifier_character_set_1, 684, lookahead)) ADVANCE(9);
      END_STATE();
    case 1:
      if (lookahead != 0 &&
    ...
    case 3:
      ...
      END_STATE();
    case 4:
      ACCEPT_TOKEN(aux_sym_multiplication_token1);
      if (('0' <= lookahead && lookahead <= '9')) ADVANCE(4);
      END_STATE();
    case 5:
    ...
    case 9:
      ...
      if (set_contains(sym__identifier_character_set_2, 802, lookahead)) ADVANCE(9);
      END_STATE();
    case 10:
...
static const uint16_t ts_parse_table[LARGE_STATE_COUNT][SYMBOL_COUNT] = {
  [STATE(0)] = {
    ...
    [aux_sym_multiplication_token1] = ACTIONS(1),
  ...
  [STATE(1)] = {
    [sym_snippet] = STATE(28),
    [sym__node] = STATE(26),
    [sym_multiplication] = STATE(26),
    [sym_children] = STATE(26),
    [sym_siblings] = STATE(26),
    [sym_group] = STATE(26),
    [sym_tag] = STATE(26),
    [sym_name] = STATE(3),
    [sym_class] = STATE(4),
  ...
  [STATE(2)] = {
    ...
    [sym_children] = STATE(27),
    [sym_siblings] = STATE(27),
    [sym_group] = STATE(27),
    [sym_tag] = STATE(27),
    [sym_name] = STATE(3),
    [sym_class] = STATE(4),
  ...
  [STATE(6)] = {
    ...
    [sym_children] = STATE(23),
    [sym_siblings] = STATE(23),
    [sym_group] = STATE(23),
    [sym_tag] = STATE(23),
    [sym_name] = STATE(3),
    [sym_class] = STATE(4),
...
static const TSParseActionEntry ts_parse_actions[] = {
  ...
  [11] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_tag, 1, 0, 0),
  [13] = {.entry = {.count = 1, .reusable = true}}, SHIFT(16),
  [15] = {.entry = {.count = 1, .reusable = true}}, SHIFT(30),
  [17] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_tag, 2, 0, 0),
  [19] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_tag_repeat1, 2, 0, 0),
  [21] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_tag_repeat1, 2, 0, 0), SHIFT_REPEAT(10),
  [24] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_tag_repeat1, 2, 0, 0), SHIFT_REPEAT(9),
  [27] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_id, 1, 0, 0),
  [29] = {.entry = {.count = 1, .reusable = true}}, SHIFT(13),
  [31] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_class, 1, 0, 0),
  [33] = {.entry = {.count = 1, .reusable = true}}, SHIFT(12),
  [35] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_name, 1, 0, 0),
  [37] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_class, 2, 0, 0),
  [39] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_id, 2, 0, 0),
  [41] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_tag, 3, 0, 0),
  [43] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_property, 1, 0, 0),
  [45] = {.entry = {.count = 1, .reusable = true}}, SHIFT(19),
  [47] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_text, 3, 0, 0),
  [49] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_property, 2, 0, 0),
  [51] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_group, 3, 0, 0),
  [53] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_multiplication, 3, 0, 0),
  [55] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_children, 3, 0, 0),
  [57] = {.entry = {.count = 1, .reusable = true}}, SHIFT(29),
  [59] = {.entry = {.count = 1, .reusable = true}}, SHIFT(6),
  [61] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_siblings, 3, 0, 0),
...
TS_PUBLIC const TSLanguage *tree_sitter_emmet(void) {
